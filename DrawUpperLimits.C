...
TCanvas * c1 = new TCanvas("c1"," Canvas ", 0,0,700,700);
 ...
 gr1s= new TGraphAsymmErrors(n,st,expL,est,est,m1s,p1s);
 gr2s= new TGraphAsymmErrors(n,st,expL,est,est,m2s,p2s);
 grex= new TGraphAsymmErrors(n,st,expL,est,est,est,est);
 grob= new TGraphAsymmErrors(n,st,obsL,est,est,est,est);
...
float tsize=0.035;
  tex = new TLatex(t1,t2,"2.3 fb^{-1} (13 TeV)");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(tsize);
  tex->SetLineWidth(2);
  tex->Draw();
  TLatex *   tex = new TLatex(t3,t4,"Upper Limits, 95% CL");
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(tsize);
  tex->SetLineWidth(2);
  tex->Draw();
  TLatex *   tex = new TLatex(t5,t6,"Multiplicity, N #geq "+nobj);
  tex->SetNDC();
  tex->SetTextFont(42);
  tex->SetTextSize(tsize);
  tex->SetLineWidth(2);
  tex->Draw();
  TLatex *   tex = new TLatex(0.2,t4,"CMS");
  tex->SetNDC();
  tex->SetTextFont(62);
